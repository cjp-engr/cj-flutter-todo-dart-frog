...
import 'package:todo_frontend/0_data/repositories/todo_repo_impl.dart';
import 'package:todo_frontend/0_data/repositories/user_repo_impl.dart';
...
import 'package:todo_frontend/1_domain/usecases/todo_usecases.dart';
import 'package:todo_frontend/1_domain/usecases/user_usecases.dart';
import 'package:todo_frontend/2_application/core/routes/routes.dart';
import 'package:todo_frontend/2_application/core/storage/shared_preferences.dart';
import 'package:todo_frontend/2_application/core/storage/storage_interface.dart';
...
import 'package:todo_frontend/2_application/pages/completed_todos/bloc/completed_todo_bloc.dart';
...
import 'package:todo_frontend/2_application/pages/settings/bloc/settings_bloc.dart';
...
Future<void> init() async {
  ...
  //   () => TodoRemoteDatasourceImpl(fbAuth: sl(), fbDatabase: sl()),
  // );
